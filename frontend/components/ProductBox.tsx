...
const ProductBox: React.FC<ProductBoxProps> = ({
  ...
  <div className="bg-white rounded-2xl shadow p-8 flex flex-col items-start border border-gray-100 hover:shadow-lg transition group">
    ...
    <h2 className="text-xl font-bold mb-2 text-primary group-hover:text-primary transition">
      {title}
    </h2>
    ...
    {link && (
      <a
        ...
        className="mt-2 inline-block px-5 py-2 rounded-full font-semibold text-sm border border-primary text-primary bg-white hover:bg-slate-50 transition shadow-sm"
      >
        Découvrir
      </a>
    )}
